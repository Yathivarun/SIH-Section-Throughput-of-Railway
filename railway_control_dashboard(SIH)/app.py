...
def live_operations_page():
    ...
    with right_column:
        ...
        st.image(
            "https://raw.githubusercontent.com/Yathivarun/SIH-Section-Throughput-of-Railway/refs/heads/main/railway_control_dashboard(SIH)/Live_map.jpg", # Placeholder image
...
def simulation_studio_page():
    ...
    with right_column:
        ...
        if 'simulation_run' in st.session_state and st.session_state.simulation_run:
            ...
            st.image(
                "https://raw.githubusercontent.com/Yathivarun/SIH-Section-Throughput-of-Railway/refs/heads/main/railway_control_dashboard(SIH)/Simulation_map.png", # Placeholder image
